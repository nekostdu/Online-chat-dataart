...
export class WsClient {
        ...
        this.client = new Client({
            ...
            onConnect: () => {
                ...
                this.subs.forEach((entry, dest) => {
                    entry.sub = this.client.subscribe(dest, (msg) => this.dispatch(msg, entry.handler));
                });
    ...
    reportActivity() {
        ...
        const now = Date.now();
        if (now - this.lastActivitySentAt < this.ACTIVITY_THROTTLE_MS)
            return;
